...
export const POSEIDON: VesselConfig = {
  ...
  /*
   * فواتير المركب من القاعدة — بأمر المالك ٨ سبتمبر ٢٠٢٦.
   *
   * كما في ألكوديا: المشتريات تُقسَّط بشهور إهلاكها وتُطرح من صافي التشغيل،
   * وفاتورة البنكر تُحمَّل كاملةً في شهرها فوق تموينات الدفتر. والاسم هو اسم
   * السفينة في بذر `VesselsService` حرفاً بحرف، وإلا عاد المركب بلا فواتير
   ...
   * في هذه الشهور: تصحيحٌ هناك لا يظهر هنا حتّى يُحدَّث هذا الجدول أو يُحذف.
   * والشهور بعد يوليو تُقرأ من القيود المستورَدة.
   */
  salariesByMonth: {
    '2026-01': 106009.02, '2026-02': 100105.83, '2026-03': 100559.48,
    '2026-04': 140422.72, '2026-05': 97721.97, '2026-06': 97199.18, '2026-07': 95845.93,
  },
  /*
