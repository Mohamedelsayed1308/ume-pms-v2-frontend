 ...
 * الذي يستحقّ انتباه الإدارة؟ ثم ينزل التقرير من Analysis إلى التفاصيل إلى الكشوف.
 *
 * ولا كلمة «ملحق» في تقارير النظام — أمر المالك في ٢٥ أغسطس ٢٠٢٦: توحي بأنّ
 * ما تحتها هامشٌ يُتخطّى، وهي كشوفُ التفصيل التي يُراجَع بها كلّ رقم.
 *
          ...
          <div className="vb-page">
            ...
            <div className="box">
              ...
              <div className="li"><span className="d">·</span><span>
                ...
                العمولات التعاقدية بندًا بندًا (كشف التفاصيل).
              </span></div>
