...
/*
 * ═══════════════════════════════════════════════════════════════════════════
 * لوحة الإدارة — المستحقّات والمدفوعات والمهام
 *
 * كانت هي الصفحة الرئيسيّة وحدها. وصارت **مكوّناً يُعرض في موضعين** بأمر
 * المالك في ٢٨ أغسطس ٢٠٢٦:
 *
 *   `/dashboard`             أسفل الأسطول والسوق — فما يهمّ الإدارة التنفيذيّة أوّلاً
 *   `/dashboard/management`  وحدها بشاشةٍ في السايدبار — لمن يقصدها قصداً
 *
 * والتكرار مقصود: من اعتاد أن يجدها في الرئيسيّة لا يُقطع عليه طريقه، ومن
 * يريدها وحدها بلا تمريرٍ طويل يجدها باسمها.
 * ═══════════════════════════════════════════════════════════════════════════
 */
