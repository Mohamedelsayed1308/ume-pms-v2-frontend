...
const DICT: Record<string, { ar: string; en: string }> = {
  ...
  'ves.fleetOnly': { ar: 'من شيت الأسطول', en: 'Fleet sheet only' },
  'ves.fleetOnlyHint': { ar: 'يعمل في الأسطول ولم يُسجَّل في النظام بعد — فلا فواتير له ولا أوامر شراء.', en: 'Sailing in the fleet but not yet registered here — no invoices or purchase orders.' },
  'ves.register': { ar: 'سجّله في النظام', en: 'Register' },
