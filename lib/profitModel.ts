...
export interface VesselInput {
   ...
   * ويُقسم بقاعدةٍ أخرى: ٦٦.٦٧٪ لشريك المركب و٣٣.٣٣٪ للآخر. فما نشأ على مركبٍ
   * لا يذهب إليه كلّه، والقسمة تجري في المحرّك.
   *
 ...
 *
 * ── القاعدة، بنصّ المستندات ──
 * **٦٦.٦٧٪ لشريك المركب الذي نشأ عليه، و٣٣.٣٣٪ للآخر.** والاتّجاه ينقلب
 * بانقلاب المنشأ — وهذا ما كتبته ستّة مستندات:
 *
 *   مارس ٢٠٢٦ · بوسيدون ٣٠   «يُقسم ٦٦.٦٧٪ لبدوي و٣٣.٣٣٪ للاتحاد»
 *   يونيو ٢٠٢٦ · بوسيدون ٦٣ و٦٤   «٦٦.٦٧٪ لبدوي و٣٣.٣٣٪ للاتحاد»
 ...
 *
 * وكان هذا الملفّ يُعطي ما نشأ على أمل **كلّه** للاتحاد — بُني على مستندٍ واحد
 * نشأ فيه Over Pax على بوسيدون وحده، فلم تُرَ الحالة المقابلة. وأثر الخطأ في
 * فبراير ١٤–٢٧ وحدها: ثلثُ ٣٣٬٠٥٠.٨٣ في الجهة الخطأ.
 *
...
function splitOverPax(active: VesselInput[]): { share: Record<string, number>; unproven: boolean } {
  ...
  for (const v of active) {
    ...
    // الأكثر لشريك المركب الذي نشأ عليه، والأقلّ للآخر — والاتّجاه ينقلب معه.
    // ومركب بدوي واحدٌ هو بوسيدون، وما عداه للاتحاد.
    const own = v.key === 'poseidon' ? 'poseidon' : 'amal';
    const other = own === 'poseidon' ? 'amal' : 'poseidon';
    add(own, amount * OVER_PAX_MAJOR);
    add(other, amount * OVER_PAX_MINOR);
  }
